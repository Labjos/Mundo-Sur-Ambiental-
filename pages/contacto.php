...
<body>
  <section id="inicialContacto">  
    ...
    <div id="datosUno">
    <div id="datosVero">
      <p>CONTACTO COMERCIAL<hr></p>
      <p><i class="fas fa-address-card"></i>&nbsp &nbsp Verónica Gonzalez</p>
      <p><i class="fas fa-envelope-square"></i> &nbsp &nbsp vgonzalez@mdsambiental.com</p>
    ...
    <div id="datosDos">
      <div id="datosXavi">
      <p>CONTACTO TÉCNICO<hr></p>
      <p><i class="fas fa-address-card"></i>&nbsp &nbsp Xaxier Jordana</p>
      <p><i class="fas fa-envelope-square"></i> &nbsp &nbsp xjordana@mdsambiental.com</p>
    ...
    <div id="fondoFormulario">
      <div id="zonaRedes">
        ...
        <iv id="iconosRedes">
          ...
          <div id="iconoWass"><i class="fab fa-whatsapp-square"></i></div></div>
